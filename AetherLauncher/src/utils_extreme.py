...
def get_performance_args():
    """Retorna uma lista de flags JVM para performance EXTREMA."""
    # Estas são flags comuns para otimização de Minecraft com Java
    # Podem ser ajustadas com base em testes e versões do Java/Minecraft
    return [
        "-XX:+UseG1GC",
...
def get_compatibility_env():
    """Retorna variáveis de ambiente para compatibilidade, se necessário."""
    return {}
